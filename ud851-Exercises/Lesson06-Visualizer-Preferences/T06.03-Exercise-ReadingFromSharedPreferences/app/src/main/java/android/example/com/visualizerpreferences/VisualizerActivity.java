...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid
                (sharedPreferences.getBoolean("show_mid", true));
        mVisualizerView.setShowTreble
                (sharedPreferences.getBoolean("show_treble", true));
//        mVisualizerView.setMinSizeScale(1);
        Float minSizeString = Float.
                parseFloat(sharedPreferences.getString("size", "1.0"));
        mVisualizerView.setMinSizeScale(minSizeString);
