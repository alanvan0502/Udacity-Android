...
public class MainActivity extends AppCompatActivity
    ...
    private static final String LOCATION_EXTRA = "locationExtra";
    private static final int WEATHER_LOADER = 11;
    ...
    private void loadWeatherData() {
        ...
        locBundle.putString(LOCATION_EXTRA, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader loader = loaderManager.getLoader(WEATHER_LOADER);

        if (loader == null)
            loaderManager.initLoader(WEATHER_LOADER, locBundle, this);
        else
            loaderManager.restartLoader(WEATHER_LOADER, locBundle, this);
    }
    ...
    public Loader<String[]> onCreateLoader(int i, @Nullable Bundle bundle) {
        String location = "";
        if (bundle != null) {
            location = bundle.getString(LOCATION_EXTRA);
        }
        return new FetchWeatherLoader(this, location, mLoadingIndicator);
    }
