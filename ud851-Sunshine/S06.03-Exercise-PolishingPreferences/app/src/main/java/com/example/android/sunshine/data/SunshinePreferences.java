...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String unit = sharedPreferences.getString
                (context.getResources().getString(R.string.pref_units_key),
                        context.getResources().getString(R.string.pref_units_metric));
        return unit.equals(context.getResources().getString(R.string.pref_units_metric));
    }
